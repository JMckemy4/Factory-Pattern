...
namespace FactoryPattern
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Please input the number of tires to display the vehicle!!");
            ...
            Console.WriteLine("This is the car you selected");
            vehicle1.Drive();

            Console.WriteLine($"{vehicle1.Name}");
            Console.WriteLine("----------------------------");
            Console.WriteLine($"{vehicle1.Description}");
